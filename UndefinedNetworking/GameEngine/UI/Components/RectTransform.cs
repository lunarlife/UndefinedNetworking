...
public sealed record RectTransform : UINetworkComponent, IDeserializeHandler
{
    ...
    private Identifier? _parentViewIdentifier;
    ...
    [ExcludeData] private Identifier? ParentIdentifier
    {
    ...
    {
        if (_parentViewIdentifier is not null && (Parent is null || Parent.Identifier != _parentViewIdentifier))
        {
            _parent = TargetView.Viewer.ActiveScene.GetView(_parentViewIdentifier).GetComponent<RectTransform>();
            _parent._childs.Add(this);
        }
